...
class CandidateAdmin(admin.ModelAdmin):
  list_display = ['number', 'name', 'vote_count', 'heat_score', 'is_active', 'created_at']
  list_filter = ['is_active', 'created_at']
  search_fields = ['name', 'number']
  inlines = [CandidatePhotoInline]
  readonly_fields = ['vote_count', 'heat_score', 'created_at', 'updated_at']
...
class CandidateApplicationAdmin(admin.ModelAdmin):
  ...
  list_display = [
    'name', 'user', 'status_badge', 'created_at', 'reviewed_at', 'candidate_link',
  ]
  list_filter = ['status', 'created_at', 'reviewed_at']
  search_fields = ['name', 'user__phone', 'user__nickname']
  readonly_fields = [
    'user', 'name', 'introduction', 'avatar_preview', 'status_badge',
    'candidate', 'reviewed_at', 'reviewed_by',
    'created_at', 'updated_at', 'reject_reason',
  ]
  fields = [
    'user', 'name', 'introduction', 'avatar_preview', 'status_badge',
    'reject_reason', 'candidate', 'reviewed_at', 'reviewed_by',
    'created_at', 'updated_at',
  ]
  inlines = [CandidateApplicationPhotoInline]
  ...
  def change_view(self, request, object_id, form_url='', extra_context=None):
    ...
    application = CandidateApplication.objects.get(pk=object_id)
